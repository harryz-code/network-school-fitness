...
function FoodLoggingModal({ isOpen, onClose, isDark = false, onMealLogged, preSelectedDate = null }) {
  ...
  const breakfastFoodDatabase = [
    ...
    { id: 3090, name: "Miso Soup", calories: 35, protein: 2, carbs: 4, fat: 1, fiber: 1, serving: "1 bowl (240ml)" },
    { id: 3091, name: "Tofu Egg Drop Soup", calories: 85, protein: 8, carbs: 3, fat: 5, fiber: 0.5, serving: "1 bowl (240ml)" },
    { id: 3092, name: "Silken Tofu", calories: 55, protein: 5, carbs: 2, fat: 3, fiber: 0.5, serving: "100g" },
    { id: 3093, name: "Firm Tofu", calories: 70, protein: 8, carbs: 2, fat: 4, fiber: 1, serving: "100g" },
    { id: 3094, name: "Nori (Seaweed Sheet)", calories: 5, protein: 1, carbs: 1, fat: 0, fiber: 0.3, serving: "1 sheet" },
    { id: 3095, name: "Wakame Seaweed", calories: 5, protein: 0.3, carbs: 0.9, fat: 0.1, fiber: 0.5, serving: "1 tbsp" },
    { id: 3096, name: "Tamago (Japanese Omelette)", calories: 120, protein: 8, carbs: 3, fat: 8, fiber: 0, serving: "1 slice" },
    { id: 3097, name: "Grilled Salmon (small)", calories: 140, protein: 25, carbs: 0, fat: 4, fiber: 0, serving: "80g" },
    { id: 3098, name: "Pickled Vegetables (Tsukemono)", calories: 10, protein: 0.5, carbs: 2, fat: 0, fiber: 1, serving: "2 tbsp" },
    { id: 3099, name: "Japanese Rice (Steamed)", calories: 140, protein: 3, carbs: 31, fat: 0.3, fiber: 0.4, serving: "1/2 cup" },

    // Nuts & Seeds (Extended)
    { id: 3100, name: "Fried Peanuts", calories: 180, protein: 8, carbs: 5, fat: 15, fiber: 2.5, serving: "1 oz (28g)" },
    { id: 3101, name: "Roasted Peanuts", calories: 170, protein: 7, carbs: 6, fat: 14, fiber: 2, serving: "1 oz (28g)" },
    { id: 3102, name: "Salted Peanuts", calories: 165, protein: 7, carbs: 5, fat: 14, fiber: 2, serving: "1 oz (28g)" },
    { id: 3103, name: "Raw Almonds", calories: 164, protein: 6, carbs: 6, fat: 14, fiber: 4, serving: "1 oz (23 nuts)" },
    { id: 3104, name: "Roasted Almonds", calories: 170, protein: 6, carbs: 5, fat: 15, fiber: 3, serving: "1 oz (23 nuts)" },
    { id: 3105, name: "Honey Roasted Peanuts", calories: 160, protein: 6, carbs: 8, fat: 13, fiber: 2, serving: "1 oz (28g)" },
    { id: 3106, name: "Wasabi Peanuts", calories: 150, protein: 6, carbs: 9, fat: 11, fiber: 2, serving: "1 oz (28g)" },
    { id: 3107, name: "Mixed Roasted Nuts", calories: 175, protein: 5, carbs: 6, fat: 16, fiber: 3, serving: "1 oz" },

    // Fresh Fruits (Individual)
    { id: 3110, name: "Banana", calories: 105, protein: 1.3, carbs: 27, fat: 0.3, fiber: 3, serving: "1 medium" },
    { id: 3111, name: "Apple", calories: 95, protein: 0.5, carbs: 25, fat: 0.3, fiber: 4, serving: "1 medium" },
    { id: 3112, name: "Orange", calories: 62, protein: 1.2, carbs: 15.4, fat: 0.2, fiber: 3.1, serving: "1 medium" },
    { id: 3113, name: "Watermelon", calories: 46, protein: 0.9, carbs: 11.5, fat: 0.2, fiber: 0.6, serving: "1 cup cubes" },
    { id: 3114, name: "Pineapple", calories: 82, protein: 0.9, carbs: 21.6, fat: 0.2, fiber: 2.3, serving: "1 cup chunks" },
    { id: 3115, name: "Papaya", calories: 62, protein: 0.7, carbs: 16, fat: 0.4, fiber: 2.5, serving: "1 cup cubes" },
    { id: 3116, name: "Mango", calories: 107, protein: 0.8, carbs: 28, fat: 0.4, fiber: 3, serving: "1 cup slices" },
    { id: 3117, name: "Dragon Fruit", calories: 60, protein: 1.2, carbs: 13, fat: 0, fiber: 3, serving: "1 cup cubes" },
    { id: 3118, name: "Kiwi", calories: 42, protein: 0.8, carbs: 10, fat: 0.4, fiber: 2.1, serving: "1 medium" },
    { id: 3119, name: "Grapes", calories: 62, protein: 0.6, carbs: 16, fat: 0.2, fiber: 0.8, serving: "1 cup" },

    // Chinese breakfast items and soups
    { id: 3200, name: "Plain Congee", calories: 150, protein: 3, carbs: 33, fat: 1, fiber: 0, serving: "1 bowl" },
    { id: 3201, name: "Chicken Congee", calories: 220, protein: 12, carbs: 34, fat: 5, fiber: 0, serving: "1 bowl" },
    { id: 3202, name: "Steamed Sweet Potato", calories: 180, protein: 3, carbs: 41, fat: 0.2, fiber: 4, serving: "200g" },
    { id: 3203, name: "Steamed Purple Potato", calories: 170, protein: 3, carbs: 39, fat: 0.2, fiber: 4, serving: "200g" },
    { id: 3204, name: "Chicken Soup", calories: 120, protein: 10, carbs: 3, fat: 7, fiber: 0, serving: "1 bowl (300ml)" },
    { id: 3205, name: "Beef Soup", calories: 150, protein: 12, carbs: 2, fat: 10, fiber: 0, serving: "1 bowl (300ml)" },
    { id: 3206, name: "Tom Yum Soup", calories: 120, protein: 8, carbs: 10, fat: 5, fiber: 1, serving: "1 bowl (300ml)" },

    // Malay breakfast items
    { id: 3210, name: "Roti Canai (plain)", calories: 300, protein: 6, carbs: 44, fat: 11, fiber: 2, serving: "1 piece" },
    { id: 3211, name: "Nasi Lemak (small)", calories: 400, protein: 10, carbs: 45, fat: 18, fiber: 2, serving: "1 small pack" },
    { id: 3212, name: "Kuih Seri Muka", calories: 180, protein: 3, carbs: 30, fat: 5, fiber: 1, serving: "1 piece" },

    // Indian breakfast items (Expanded)
    { id: 3220, name: "Idli", calories: 60, protein: 2, carbs: 12, fat: 0.4, fiber: 1, serving: "1 piece" },
    { id: 3221, name: "Dosa (plain)", calories: 170, protein: 4, carbs: 30, fat: 3, fiber: 2, serving: "1 piece" },
    { id: 3222, name: "Vada (medu)", calories: 190, protein: 4, carbs: 22, fat: 10, fiber: 2, serving: "1 piece" },
    { id: 3223, name: "Upma", calories: 200, protein: 5, carbs: 30, fat: 7, fiber: 3, serving: "1 bowl" },
    { id: 3224, name: "Poha", calories: 250, protein: 5, carbs: 45, fat: 5, fiber: 3, serving: "1 bowl" },
    { id: 3225, name: "Aloo Paratha", calories: 320, protein: 7, carbs: 45, fat: 12, fiber: 4, serving: "1 piece" },
    { id: 3226, name: "Butter Chicken with Rice", calories: 520, protein: 32, carbs: 45, fat: 24, fiber: 2, serving: "1 serving" },
    { id: 3227, name: "Chicken Tikka Masala with Rice", calories: 480, protein: 30, carbs: 42, fat: 22, fiber: 3, serving: "1 serving" },
    { id: 3228, name: "Vegetable Curry with Rice", calories: 350, protein: 12, carbs: 58, fat: 8, fiber: 8, serving: "1 serving" },
    { id: 3229, name: "Dal (Lentil Curry) with Rice", calories: 320, protein: 18, carbs: 52, fat: 4, fiber: 12, serving: "1 serving" },
    { id: 3230, name: "Palak Paneer with Rice", calories: 420, protein: 20, carbs: 45, fat: 18, fiber: 6, serving: "1 serving" },
    { id: 3231, name: "Masala Dosa", calories: 280, protein: 8, carbs: 45, fat: 8, fiber: 4, serving: "1 piece" },
    { id: 3232, name: "Chole Bhature", calories: 450, protein: 15, carbs: 65, fat: 15, fiber: 8, serving: "1 serving" },
    { id: 3233, name: "Puri Sabzi", calories: 380, protein: 10, carbs: 55, fat: 14, fiber: 6, serving: "1 serving" },

    // More Malaysian breakfast items
    { id: 3240, name: "Nasi Lemak (regular)", calories: 550, protein: 15, carbs: 65, fat: 25, fiber: 3, serving: "1 regular pack" },
    { id: 3241, name: "Coconut Rice", calories: 320, protein: 5, carbs: 52, fat: 12, fiber: 2, serving: "1 cup" },
    { id: 3242, name: "Chicken Curry with Rice", calories: 480, protein: 28, carbs: 45, fat: 22, fiber: 2, serving: "1 serving" },
    { id: 3243, name: "Rendang with Rice", calories: 520, protein: 25, carbs: 48, fat: 26, fiber: 3, serving: "1 serving" },
    { id: 3244, name: "Roti Telur (egg)", calories: 380, protein: 12, carbs: 45, fat: 16, fiber: 2, serving: "1 piece" },
    { id: 3245, name: "Teh Tarik", calories: 120, protein: 4, carbs: 18, fat: 4, fiber: 0, serving: "1 cup" },
    { id: 3246, name: "Kopi O", calories: 5, protein: 0, carbs: 1, fat: 0, fiber: 0, serving: "1 cup" },
    { id: 3247, name: "Kuih Lapis", calories: 160, protein: 2, carbs: 28, fat: 4, fiber: 1, serving: "1 piece" },
    { id: 3248, name: "Onde-onde", calories: 140, protein: 2, carbs: 25, fat: 4, fiber: 2, serving: "3 pieces" },

    // More Chinese breakfast items & Dim Sum
    { id: 3250, name: "Pork Congee", calories: 240, protein: 14, carbs: 34, fat: 6, fiber: 0, serving: "1 bowl" },
    { id: 3251, name: "Fish Congee", calories: 200, protein: 15, carbs: 33, fat: 3, fiber: 0, serving: "1 bowl" },
    { id: 3252, name: "Century Egg Congee", calories: 230, protein: 10, carbs: 35, fat: 6, fiber: 0, serving: "1 bowl" },
    { id: 3253, name: "Steamed Pork Bun (Char Siu Bao)", calories: 200, protein: 8, carbs: 28, fat: 6, fiber: 1, serving: "1 bun" },
    { id: 3254, name: "Steamed Custard Bun", calories: 180, protein: 5, carbs: 32, fat: 4, fiber: 1, serving: "1 bun" },
    { id: 3255, name: "Har Gow (Shrimp Dumpling)", calories: 45, protein: 3, carbs: 5, fat: 1, fiber: 0, serving: "1 piece" },
    { id: 3256, name: "Siu Mai (Pork Dumpling)", calories: 55, protein: 4, carbs: 4, fat: 3, fiber: 0, serving: "1 piece" },
    { id: 3257, name: "Wonton Soup", calories: 180, protein: 8, carbs: 20, fat: 7, fiber: 1, serving: "1 bowl" },

    // Western breakfast items
    { id: 3260, name: "Pork Sausage", calories: 280, protein: 12, carbs: 2, fat: 25, fiber: 0, serving: "2 links" },
    { id: 3261, name: "Chicken Sausage", calories: 180, protein: 14, carbs: 3, fat: 12, fiber: 0, serving: "2 links" },
    { id: 3262, name: "Turkey Bacon", calories: 60, protein: 8, carbs: 0, fat: 3, fiber: 0, serving: "2 strips" },
    { id: 3263, name: "Pork Bacon", calories: 90, protein: 6, carbs: 0, fat: 7, fiber: 0, serving: "2 strips" },
    { id: 3264, name: "Baked Beans", calories: 155, protein: 6, carbs: 29, fat: 1, fiber: 6, serving: "1/2 cup" },
    { id: 3265, name: "Hash Browns", calories: 150, protein: 2, carbs: 15, fat: 9, fiber: 2, serving: "1/2 cup" },
    { id: 3266, name: "Pancakes (3 medium)", calories: 350, protein: 8, carbs: 58, fat: 10, fiber: 2, serving: "3 pancakes" },
    { id: 3267, name: "French Toast", calories: 220, protein: 8, carbs: 28, fat: 9, fiber: 2, serving: "2 slices" },
    { id: 3268, name: "Waffles", calories: 290, protein: 6, carbs: 37, fat: 14, fiber: 1, serving: "2 waffles" },
    { id: 3269, name: "Avocado Toast", calories: 280, protein: 8, carbs: 30, fat: 18, fiber: 12, serving: "2 slices" },

    // More fruits
    { id: 3270, name: "Mango (sliced)", calories: 107, protein: 1, carbs: 28, fat: 0, fiber: 3, serving: "1 cup" },
    { id: 3271, name: "Grapes", calories: 104, protein: 1, carbs: 27, fat: 0, fiber: 1, serving: "1 cup" },
    { id: 3272, name: "Kiwi", calories: 61, protein: 1, carbs: 15, fat: 0, fiber: 3, serving: "1 medium" },
    { id: 3273, name: "Strawberries", calories: 49, protein: 1, carbs: 12, fat: 0, fiber: 3, serving: "1 cup" },
    { id: 3274, name: "Blueberries", calories: 84, protein: 1, carbs: 21, fat: 0, fiber: 4, serving: "1 cup" },

    // Coffee options
    { id: 3280, name: "Black Coffee", calories: 5, protein: 0, carbs: 1, fat: 0, fiber: 0, serving: "1 cup" },
    { id: 3281, name: "Espresso", calories: 3, protein: 0, carbs: 0, fat: 0, fiber: 0, serving: "1 shot" },
    { id: 3282, name: "Americano", calories: 5, protein: 0, carbs: 1, fat: 0, fiber: 0, serving: "1 cup" },
    { id: 3283, name: "Cappuccino", calories: 80, protein: 4, carbs: 8, fat: 4, fiber: 0, serving: "1 cup" },
    { id: 3284, name: "Latte", calories: 120, protein: 6, carbs: 12, fat: 6, fiber: 0, serving: "1 cup" },
    { id: 3285, name: "Flat White", calories: 100, protein: 5, carbs: 9, fat: 5, fiber: 0, serving: "1 cup" },
    { id: 3286, name: "Macchiato", calories: 15, protein: 1, carbs: 2, fat: 1, fiber: 0, serving: "1 cup" },
    { id: 3287, name: "Mocha", calories: 200, protein: 8, carbs: 26, fat: 8, fiber: 2, serving: "1 cup" },
    { id: 3288, name: "Frappuccino", calories: 240, protein: 4, carbs: 50, fat: 3, fiber: 0, serving: "1 cup" },
    { id: 3289, name: "Iced Coffee (black)", calories: 5, protein: 0, carbs: 1, fat: 0, fiber: 0, serving: "1 cup" },
    { id: 3290, name: "Cold Brew", calories: 5, protein: 0, carbs: 1, fat: 0, fiber: 0, serving: "1 cup" },

    // Desserts & Ice Cream
    { id: 3300, name: "Vanilla Ice Cream", calories: 140, protein: 2, carbs: 16, fat: 7, fiber: 0, serving: "1/2 cup" },
    { id: 3301, name: "Chocolate Ice Cream", calories: 160, protein: 3, carbs: 20, fat: 8, fiber: 1, serving: "1/2 cup" },
    { id: 3302, name: "Strawberry Ice Cream", calories: 130, protein: 2, carbs: 18, fat: 6, fiber: 0, serving: "1/2 cup" },
    { id: 3303, name: "Cookies & Cream Ice Cream", calories: 170, protein: 3, carbs: 20, fat: 9, fiber: 1, serving: "1/2 cup" },
    { id: 3304, name: "Mint Chocolate Chip Ice Cream", calories: 150, protein: 3, carbs: 16, fat: 8, fiber: 0, serving: "1/2 cup" },
    { id: 3305, name: "Chocolate Chip Cookie", calories: 160, protein: 2, carbs: 22, fat: 8, fiber: 1, serving: "1 cookie" },
    { id: 3306, name: "Oatmeal Cookie", calories: 140, protein: 2, carbs: 20, fat: 6, fiber: 1, serving: "1 cookie" },
    { id: 3307, name: "Glazed Donut", calories: 260, protein: 3, carbs: 31, fat: 14, fiber: 1, serving: "1 donut" },
    { id: 3308, name: "Chocolate Donut", calories: 280, protein: 4, carbs: 35, fat: 15, fiber: 2, serving: "1 donut" },
    { id: 3309, name: "Apple Pie", calories: 320, protein: 3, carbs: 52, fat: 12, fiber: 3, serving: "1 slice" },
    { id: 3310, name: "Cheesecake", calories: 400, protein: 6, carbs: 32, fat: 28, fiber: 1, serving: "1 slice" },
    { id: 3311, name: "Tiramisu", calories: 350, protein: 6, carbs: 35, fat: 20, fiber: 1, serving: "1 slice" },
    { id: 3312, name: "Chocolate Cake", calories: 380, protein: 4, carbs: 58, fat: 16, fiber: 3, serving: "1 slice" }
  ]
